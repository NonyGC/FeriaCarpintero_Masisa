...
{
    public partial class FrmParticipante : RadForm
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                partEst = partCN.participanteInsertCN(partCE) ? true : false; accionBtn = "REGISTRÓ";
            }
            if (btnGuardar.Text == "ACTUALIZAR")
            {
                partEst = partCN.participanteUpdateCN(partCE) ? true : false; accionBtn = "ACTUALIZÓ";
            }
